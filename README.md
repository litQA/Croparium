...
- Jar Files: Licensed under **CC-BY-NC 4.0**

## Usage and Distribution Instructions
...
以后LitQA也会持续维护优化和构思更多有意思的内容，提升游戏体验，不辜负每一份喜欢~
...
## 專案簡介
- **源植術**是一款為 Minecraft 設計的實用模組，旨在為玩家提供全新的資源獲取方式，豐富遊戲體驗。
...
## Описание проекта
**Ресурсная культивация** — практичный мод для Minecraft, созданный для предоставления игрокам нового способа получения ресурсов и обогащения игрового опыта.
...
<details><summary>클릭하여 접기/펼치기 프로젝트 설명</summary>

## 프로젝트 개요
만물 육성 기술은 마인크래프트를 위해 설계된 실용적인 모드로，플레이어에게 새로운 자원 획득 방식을 제공하여 게임 경험을 풍부하게 하는 것을 목표로 합니다.

본 모드는 모잉 EULA를 준수하며，오직 비상업적 용도로만 사용됩니다. 매매하거나 상업적 이익을 취하기 위한 사용은 엄금됩니다.

## 라이선스 조항
- 소스 코드：모든 권리를 보유합니다

- 리소스 파일（텍스처、모델 등）：크리에이티브 커먼즈 저작자표시-비상업적 이용 4.0 국제 라이선스를 적용합니다.

- Jar 문서：크리에이티브 커먼즈 저작자표시-비상업적 이용 4.0 국제 라이선스를 적용합니다.

## 사용 및 배포 설명

자신의 모드 팩에서 본 모드를 자유롭게 사용할 수 있습니다；비상업적 사용을 전제로，자유롭게 배포할 수 있습니다.
</details>


# 万物栽培技術

<details><summary>クリックで折りたたみ/展開 プロジェクト説明</summary>

## プロジェクト概要
- 万物栽培技術は Minecraft 向けに開発された実用的なモッドで、プレイヤーに新しいリソース入手方法を提供し、ゲーム体験を豊かにすることを目的としています。
- 本モッドは Mojang EULA に準拠しており、非営利目的での使用に限られます。転売や営利目的での利用を固く禁止します。
## ライセンス条項
- ソースコード：全ての権利を留保
- リソースファイル（テクスチャ、モデルなど）：クリエイティブ・コモンズ 表示 - 非営利 4.0 国際ライセンスに基づき許諾
- Jar ファイル：クリエイティブ・コモンズ 表示 - 非営利 4.0 国際ライセンスに基づき許諾
## 使用と頒布に関する注意
自作の整合パックにおいて本モッドを自由に使用できます。非営利目的の範囲内で、自由に頒布することができます。
</details>
